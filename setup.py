...
# Package meta-data.
NAME = 'NodeCoder'
DESCRIPTION = 'Chracterizing the proteins amino acid residues to predict protein functions.'
...
REQUIRED = [
     "scipy>=1.5.4", "numpy>=1.19.2", "pandas>=1.1.5", "matplotlib>=3.3.3",
     ...
     "scikit-learn>=0.23.2", "matplotlib>=3.3.3", "texttable>=1.6.3"
             ]
